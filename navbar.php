    ...
    <div class="row">
        ...
        <div class="col">
            <ul class="nav justify-content-center">
                <li class="nav-item">
                    <a class="nav-link fw-bold text-danger" aria-current="page" href="#">Hasta 50% OFF</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold text-dark" href="#">Mujeres</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold text-dark" href="#">Hombres</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link fw-bold text-dark" href="#">Niños</a>
                </li>
            </ul>
        </div>
